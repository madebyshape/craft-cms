...
### Changed
- Removed license keys from project config.

## 5.2.6 - 2026-06-09

### Added
- Security headers, gzip compression, far-future asset caching, and disabled directory listings in `web/.htaccess` as safe defaults for Apache-hosted deployments.
